...
Consult the [docs](https://gluu.org/docs/ce/latest/installation-guide/install/) of the respective distribution about how to install the Gluu Server using the package manager.
