...
Learn more about [how to write a custom interception script](../customize/auth-script.md).

Review our [custom authentication script tutorial](../customize/script.md), where we demonstrate how to write a script to implement OTP authentication using Twilio to send an SMS code for a two-step out-of-band authentication mechanism.
