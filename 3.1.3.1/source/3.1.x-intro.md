...
### Code White Patch
In August 2018, a critical vulnerability was discovered in the Jboss Richfaces library, and our team immediately released a [patch](./upgrade/patches/#code-white-patch). Version 3.1.3.1 comes with that patch pre-implemented, but is otherwise identical to 3.1.3.
