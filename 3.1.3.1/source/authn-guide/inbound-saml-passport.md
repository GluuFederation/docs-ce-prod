...
## Prerequisites
- Gluu Server CE 3.1.3.1 with Passport.js   
...
1. Click the "Update" at the bottom of the page.
   ![](https://github.com/GluuFederation/docs-ce-prod/blob/3.1.3.1/3.1.3.1/source/img/user-authn/passport/update_passport_02.png)   
...
1. Select "Enabled" from `Passport Support` drop-down list and click "Update"
   ![](https://github.com/GluuFederation/docs-ce-prod/blob/3.1.3.1/3.1.3.1/source/img/user-authn/passport/passport_auth_method_03.png)    
