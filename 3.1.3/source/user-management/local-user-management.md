...
You will need an LDAP browser like [JXplorer](http://jxplorer.org/) and can find configuration in `/opt/gluu-server-3.1.3/etc/gluu/conf/ox-ldap.properties`, e.g.:
