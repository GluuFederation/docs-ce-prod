...
| Install Gluu Server     | `# apt-get install gluu-server-3.1.3.sp1`      |
...
| Install Gluu Server     | `# yum install gluu-server-3.1.3.sp1`         |
...
```
# service gluu-server-3.1.3.sp1` start
# service gluu-server-3.1.3.sp1` login
```

For Centos 7.x and Red Hat 7.x, run the following commands: 

```
# /sbin/gluu-serverd-3.1.3.sp1 enable
# /sbin/gluu-serverd-3.1.3.sp1 start
# /sbin/gluu-serverd-3.1.3.sp1 login
```
...
```
# service gluu-server-3.1.3.sp1 stop
# apt-get remove gluu-server-3.1.3.sp1
# rm -rf /opt/gluu-server-3.1.3.sp1.save
```
...
```
# service gluu-server-3.1.3.sp1 stop
# yum remove gluu-server-3.1.3.sp1
# rm -rf /opt/gluu-server-3.1.3.sp1.save
```
...
```
# /sbin/gluu-serverd-3.1.3.sp1 disable
# /sbin/gluu-serverd-3.1.3.sp1 stop
# yum remove gluu-server-3.1.3.sp1 
# rm -rf /opt/gluu-server-3.1.3.sp1.save
```

!!! Note
    You can also use `apt-get purge gluu-server-3.1.3.sp1` or `apt-get remove --purge gluu-server-3.1.3.sp1` to uninstall and remove all the folders and services of Gluu server.
