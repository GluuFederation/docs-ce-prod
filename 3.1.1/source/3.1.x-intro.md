...
We have certified Gluu Server 3.1.1 for all five [OpenID Connect Provider tests](http://openid.net/certification/) (Basic OP, Implicit OP, Hybrid OP, Config OP, Dynamic OP).  
...
The Gluu Server 3.1.x supports the latest version of our free and secure two-factor authentication (2FA) mobile app, [Super Gluu](https://super.gluu.org), out-of-the-box. Simply [follow the docs](https://gluu.org/docs/ce/3.1.1/authn-guide/supergluu) to enable Super Gluu authentication.
