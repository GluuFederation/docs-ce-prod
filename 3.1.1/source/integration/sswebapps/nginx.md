...
Requirements:
- Gluu Server ([Installation Instructions](https://gluu.org/docs/ce/3.1.1/installation-guide/install/#1-install-gluu-server-package))
- OpenResty 1.11.2.5
- gcc
