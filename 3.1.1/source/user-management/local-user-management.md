...
!!!Note 
   We briefly cover the Gluu Server's **very basic** out-of-the-box user registration feature. We almost always recommend writing your own registration page and using the Gluu Server [SCIM 2.0 APIs](./scim2.md) to register users in your IAM service. 
...
You will need an LDAP browser like [JXplorer](http://jxplorer.org/) and can find configuration in `/opt/gluu-server-3.1.1/etc/gluu/conf/ox-ldap.properties`, e.g.:
