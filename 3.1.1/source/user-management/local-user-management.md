...
If you are interested to explore the LDAP tree which is inside Gluu Server, you need to establish a tunnel from your computer to the target Gluu Server's ldap. Tunneling is required because Gluu Server's LDAP port, 1636, is not exposed to the Internet.
