...
!!!Note 
   We briefly cover the Gluu Server's **very basic** out-of-the-box user registration feature. We always recommend writing your own registration page and using the Gluu Server [SCIM 2.0 APIs](./scim2.md) to register users in your IAM service. 
