...
If you have an existing Active Directory or backend LDAP server, you can sync data to your local Gluu OpenLDAP using the [Cache Refresh process](https://github.com/GluuFederation/docs-ce-prod/blob/3.1.1/3.1.1/source/user-management/ldap-sync.md). 
...
In large enterprise workflows the Gluu Server is a consumer of identity management and Governance data and policies. If you have an existing identity management platform (like SailPoint or Courion), the Gluu Server can be integrated using the System for Cross-domain Identity Management protocol, aka [SCIM]. 
