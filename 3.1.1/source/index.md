...
projects are frequently prefixed with our handle: **ox** (e.g. oxAuth, oxTrust). The license for each software component available in the Gluu Server is listed below.
