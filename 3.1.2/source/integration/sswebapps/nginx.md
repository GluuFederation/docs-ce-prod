...
Requirements:
- Gluu Server 3.1.2 ([Installation Instructions](https://gluu.org/docs/ce/3.1.2/installation-guide/install/#1-install-gluu-server-package))
- OpenResty 1.11.2.5
- gcc
