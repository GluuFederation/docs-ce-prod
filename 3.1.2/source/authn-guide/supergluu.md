...
The Gluu Server and Super Gluu can work in the same network, without a DNS server hostname and with a self-signed SSL certificate. There is only one limitation: both components should belong to the same network.
