...
1. Run one of the following command to collect the `inum` for the Gluu Server installation:   
   * **For Gluu instance with OpenDJ as LDAP implementation.**
    ...
    ```
   * **For Gluu instance with OpenLDAP as LDAP implementation.**
