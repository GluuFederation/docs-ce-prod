...
Logs can be lengthy and difficult to search. As needded, all logs inside the container can be cleared by using the clear-log option. This is explained in [clear-logs](./logs/#clearing-logs).
