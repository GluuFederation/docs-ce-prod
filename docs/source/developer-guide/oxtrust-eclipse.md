...
# yum install gluu-server-4.1

# /sbin/gluu-serverd-4.1 start 

# /sbin/gluu-serverd-4.1 enable 

# /sbin/gluu-serverd-4.1 login 
```
!!! Note: 
...
root directory of gluu chroot jail is `/opt/gluu-server-4.1/` 

download `/opt/gluu-server-4.1/root/configs.tgz` to your machine. 
