...
## Installation
Gluu publishes Linux packages for Ubuntu, CentOS, RHEL and Debian operating systems. Follow our [VM preparation guide](./installation-guide/index.md) to get started. Gluu also supports installation via [Docker containers](https://github.com/GluuFederation/docs-ce-prod/blob/3.1.6/docs/source/docker/intro.md).
