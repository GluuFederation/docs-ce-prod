...
!!! Note
    To simplify the setup of, and ongoing operations of Gluu in an HA environment, we offer a tool called [Cluster Manager](https://gluu.org/docs/cm) with the [Gluu VIP Subscription](https://gluu.org/pricing#vip).
