...
!!! Note
    To simplify setup and ongoing Cluster operations, Gluu offers the [Cluster Manager](https://gluu.org/docs/cm) tool with the [Gluu VIP Subscription](https://gluu.org/pricing#vip).
