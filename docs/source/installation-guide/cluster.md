...
We offer two supported strategies for HA, both of which require either a [Gluu VIP Subscription](https://gluu.org/pricing/#vip), *or* a support agreement with one of our OEM partners. 
