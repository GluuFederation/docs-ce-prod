...
159.203.126.10  idp1.example.org (Gluu Server 4.0 on Ubuntu 14)
138.197.65.243  idp2.example.org (Gluu Server 4.0 on Ubuntu 14)
```
...
scp /opt/gluu-server-4.0/install/community-edition-setup/setup.properties.last root@idp2.example.org:/opt/gluu-server-4.0/install/community-edition-setup/setup.properties
...
scp /opt/gluu-server-4.0/etc/certs/httpd.key root@loadbalancer.example.org:/etc/nginx/ssl/
scp /opt/gluu-server-4.0/etc/certs/httpd.crt root@loadbalancer.example.org:/etc/nginx/ssl/
...
scp /opt/gluu-server-4.0/etc/certs/* root@idp2.example.org:/opt/gluu-server-4.0/etc/certs/
