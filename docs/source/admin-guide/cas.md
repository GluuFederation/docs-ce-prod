...
it on [corresponding Github page](https://github.com/GluuFederation/oxAuth/tree/version_3.1.5/Server/integrations/cas2).
...
Though Gluu CE 3.1.5 doesn't offer complete CAS support in admin web UI, 
