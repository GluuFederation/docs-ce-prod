...
Place this [jar file](https://ox.gluu.org/maven/org/xdi/oxauth-client/3.1.7.Final/oxauth-client-3.1.7.Final.jar) in your classpath to compile and run the code above.
