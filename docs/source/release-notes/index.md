...
- [#26](https://github.com/GluuFederation/gluu-Asimba/issues/26) IndexOutOfBoundsException in org.opensaml.xml.util

- [#25](https://github.com/GluuFederation/gluu-Asimba/issues/25) Asimba does not logout (a session still exists in memory storage)

- [#23](https://github.com/GluuFederation/gluu-Asimba/issues/23) Allow to change the order of the IDPs via the GUI

- [#21](https://github.com/GluuFederation/gluu-Asimba/issues/21) Deploy Asimba in its own tomcat container
