...
!!! Warning
    Before upgrading, make sure to [back up](../operation/backup.md) the Gluu container or LDAP LDIF. In addition, upgrades should always be thoroughly scoped and tested on a development environment *first*.
