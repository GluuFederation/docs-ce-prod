...
The Gluu Server also supports the [SCIM protocol](./user-management/scim2.md), which can be used to push data to the Gluu Server from external identity data sources. 
