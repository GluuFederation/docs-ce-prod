...
##  oxd Client Software
To integrate web applications with the Gluu Server for SSO you can use any existing or custom written SAML or OpenID Connect client software, but you may want to consider using our commercial client software, [oxd](https://oxd.gluu.org), for the following reasons: 
