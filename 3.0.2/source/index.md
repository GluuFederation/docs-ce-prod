...
##  oxd Client Software
You can use any existing or custom written SAML or OpenID Connect client software to secure web applications with the Gluu Server and achieve single sign-on (SSO). However, you may want to consider using our commercial OpenID Connect client software, [oxd](https://oxd.gluu.org), for the following reasons: 
